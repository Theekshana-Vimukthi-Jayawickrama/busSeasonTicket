...
class _AdultSetUsernameAndPasswordState
  ...
  Future<void> savedata() async {
    ...
    File uploadedNICBack = File(widget.uploadedNICBack);
    File uploadedNICFront = File(widget.uploadedNICFront);
    ...
    request.files.add(http.MultipartFile.fromBytes(
      "uploadedNICFront",
      uploadedNICFront.readAsBytesSync(),
      filename: uploadedNICFront.path.split('/').last, // Use the file name
      contentType: MediaType('image', 'jpeg'),
    ));
    request.files.add(http.MultipartFile.fromBytes(
      "uploadedNICBack",
      uploadedNICBack.readAsBytesSync(),
      filename: uploadedNICBack.path.split('/').last, // Use the file name
      contentType: MediaType('image', 'jpeg'),
    ));
